...
public class Main {
    public static void main(String[] args) {
        ...
        Dokter dokter1 = new Dokter("WAHAB", "15 JANUARI 2000", Orang.JENIS_KELAMIN.LAKI_LAKI, "34.2.1.100.3.21.007812",
                "PENYAKIT DALAM");
        Dokter dokter2 = new Dokter("BELDA", "16 FEBRUARI 2003", Orang.JENIS_KELAMIN.PEREMPUAN,
                "34.2.1.100.3.21.001234", "ANAK");
        Dokter dokter3 = new Dokter("FAUZI", "17 MARET 2002", Orang.JENIS_KELAMIN.LAKI_LAKI, "34.2.1.100.3.21.005342",
                "PENYAKIT KULIT");
        Dokter dokter4 = new Dokter("EZRA", "18 APRIL 2000", Orang.JENIS_KELAMIN.LAKI_LAKI, "34.2.1.100.3.21.006772",
                "PENYAKIT JANTUNG");
        ...
        Pasien pasien4 = new Pasien("EDELINE", "22 SEPTEMBER 2005", Orang.JENIS_KELAMIN.LAKI_LAKI, "Mahasiwa",
                "POGUNG");
        ...
        pasien1.daftar(rumahSakit1, "PUSING", "WAHAB", Antrian.TIPE_PASIENS.MANDIRI);
        pasien2.daftar(rumahSakit1, "PILEK", "WAHAB", Antrian.TIPE_PASIENS.MANDIRI);
        pasien3.daftar(rumahSakit1, "MASUK ANGIN", "BELDA", Antrian.TIPE_PASIENS.MANDIRI);
        pasien6.daftar(rumahSakit1, "KESELEO", "BELDA", Antrian.TIPE_PASIENS.MANDIRI);
        pasien4.daftar(rumahSakit1, "FLU", "FAUZI", Antrian.TIPE_PASIENS.MANDIRI);

        pasien5.daftar(rumahSakit1, "BATUK", "LUTHFI", Antrian.TIPE_PASIENS.MANDIRI);
        pasien5.daftar(rumahSakit1, "BATUK", "EZRA", Antrian.TIPE_PASIENS.MANDIRI);
        pasien5.daftar(rumahSakit1, "BATUK", "EZRA", Antrian.TIPE_PASIENS.MANDIRI);
